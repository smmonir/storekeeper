...
class DashboardController extends Controller
{
    function dashboard() {
        ...
        return view('dashboard', ["products"=>$products, "totalSell"=>$totalSell, "todayTotalSell"=>$todayTotalSell, "yesterdayTotalSell"=>$yesterdayTotalSell, "thismonthTotalSell"=>$thismonthTotalSell, "lastmonthTotalSell"=>$lastmonthTotalSell]);
    }
}
